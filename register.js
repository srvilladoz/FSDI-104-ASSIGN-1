...
function init(){
    console.log("init");
    var scooby=new Pet("Scooby",50,"Male","Dane","Shower","Shaggy","555-555-5555");
    var scrappy=new Pet("Scrappy",40,"Male","Dane","Nails cut","Shaggy","666-666-6666");
    var genie=new Pet("Genie",5,"Female","Maltipoo","bath","Jane","777-777-7777");
    var pebbles=new Pet("Pebbles",2,"Female","Schnauzer","bath","Jane","888-888-8888");
